...
public class Winstead_Ryan_P1_5 extends PApplet {
...
public void victoryScreen()
{
  ...
  public void settings() {  size(1200, 712); }
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "--present", "--window-color=#666666", "--stop-color=#cccccc", "Winstead_Ryan_P1_5" };
    if (passedArgs != null) {
